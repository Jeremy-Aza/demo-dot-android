...
class BasicMagnifEyeLivenessFragment : MagnifEyeLivenessFragment() {
    ...
    private val magnifEyeLivenessViewModel: MagnifEyeLivenessViewModel by activityViewModels { com.example.autocapture.magnifeyeliveness.MagnifEyeLivenessViewModelFactory() }
