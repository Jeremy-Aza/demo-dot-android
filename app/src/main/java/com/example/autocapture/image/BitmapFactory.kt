package com.example.autocapture.image
...
fun Image.createBitmap(): Bitmap {
    return when (this.format) {
        ImageFormat.JPEG_2000 -> com.example.autocapture.image.createBitmapFromJpeg2000(this.bytes)
        else -> com.example.autocapture.image.createBitmap(this.bytes)
    }
}
